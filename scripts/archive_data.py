...
def latest_archive_sha(data_dir: Path = DATA_DIR) -> str | None:
...
def run(source: Path, data_dir: Path, changelog: Path) -> None:
    """Core archive logic; separated for testability."""
    ...
    previous_sha = latest_archive_sha(data_dir)
